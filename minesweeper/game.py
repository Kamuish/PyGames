...
class Board:
    ...
    def calculate_near_bombs(self):
        """
        Add, to each tile, the number of bombs around him
        """
    ...
    def get_near_bombs(self,x,y):
        """
        Only called when the tile is clicked upon. gives the number of bombs
        """
        self.revealed += 1
    ...
    def flag(self,x,y):
        """
            Sets/unsets the flag for a given tile.  
            Keeps track of the correct/incorrect flags
        """
    ...
    def is_finished(self):
        """
            Sees if the game is already over or not
        """
    ...
    def place_random_bombs(self, how_many = None):
        """
        Place the number of bombs on the game board
        """
        missing = 0
        n_tiles = self.size_x * self.size_y
        if how_many is None:
